...
cuando es la primera vez (conectar con repositorio en github) git init git add . git commit -m "Primer commit" git remote add origin https://github.com/TU-USUARIO/NOMBRE-REPO.git git push -u origin main
